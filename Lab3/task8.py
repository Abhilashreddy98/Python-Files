...
# Filters are added to the ENV object after declaration. 
# Note that we're actually passing in our "get_interface_speed" function and not running
# it--the template engine will execute this function when we call template.render()
